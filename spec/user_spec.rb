...
describe User do
  ...
  describe '.create' do
    it 'creates a new user on the database and returns it as User object' do
      new_user = User.create(username: 'blahblah', email: 'blahblah@notadomain.com', password: 'password1',
    ...
    it 'hashes the password using BCrypt' do
      ...
      User.create(username: 'cheaphouseperson', email: 'cheaphouseperson@notadomain.com', password: 'password1',
                  first_name: 'Isabel', last_name: 'Stephenson')
    end
  end
  ...
  describe '.sign_in' do
    it 'allows existing user to sign in' do
      new_user = User.create(username: 'poorerhouseperson', email: 'poorerhouseperson@notadomain.com',
                             password: 'password2', first_name: 'Izzy', last_name: 'Stevenson')
