...
def reset_table
  ...
  User.create(username: 'poshhouseperson', email: 'poshhouseperson@notadomain.com', password: 'password1', first_name: 'Isabel', last_name: 'Stephenson')

  Listing.create(name: 'poshhouse', country: 'United Kingdom', city: 'London', sleeps: '6', bedrooms: '4', bathrooms: '3', 
